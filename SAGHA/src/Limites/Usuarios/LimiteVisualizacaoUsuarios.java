...
public class LimiteVisualizacaoUsuarios
{
    ...
    public LimiteVisualizacaoUsuarios(String dados[][])
    {
        String nomes[] = {"NOME","CPF","ID DO HOSPITAL"};
        ...
        frame = new JFrame("Listagem de usuarios");
        frame.add(principal);
