...
public class LimiteCadastroHospitalRegiao
{
    ...
    public LimiteCadastroHospitalRegiao(ControleHospitaisRegiao pCtrl)
    {
        objCtrl = pCtrl;
        ...
        cadastrar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                objCtrl.cadastrarRegiaoHospital();
            }
        });
    ...
    {
        JOptionPane.showMessageDialog(principal, "Regiao de hospital cadastrada!");
    }
